...
--
-- Table structure for table `patient_complaints_history`
--
...
CREATE TABLE `patient_complaints_history` (
  ...
  CONSTRAINT `patient_complaints_history_ibfk_1` FOREIGN KEY (`UHID`) REFERENCES `patients` (`UHID`),
  CONSTRAINT `patient_complaints_history_ibfk_2` FOREIGN KEY (`ComplaintType`) REFERENCES `ocular_complaint_types` (`ComplaintType`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `patient_complaints_history`
--

LOCK TABLES `patient_complaints_history` WRITE;
/*!40000 ALTER TABLE `patient_complaints_history` DISABLE KEYS */;
/*!40000 ALTER TABLE `patient_complaints_history` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2018-08-26  8:45:36

...
CREATE TABLE `patient_medical_facts` (
  ...
  `isHighBBPatient` enum('YES','NO') DEFAULT NULL,
  `isHeartPatient` enum('YES','NO') DEFAULT NULL,
  `PatientWeight` float(2,2) DEFAULT NULL,
...
INSERT INTO `staff_details` VALUES (1002,'Pritam','','Rasal','1981-11-06','male',9657564333,'pritam@gmail.com','2018-08-12 01:32:42');
...
INSERT INTO `staff_login` VALUES (1000,'prakash.rasal','e19d5cd5af0378da05f63f891c7467af','2018-07-30 21:12:35'),(1001,'wasant.ambekar','e19d5cd5af0378da05f63f891c7467af','2018-07-30 21:27:10'),(1002,'pri123','e19d5cd5af0378da05f63f891c7467af','2018-08-12 01:32:42');
...
-- Dump completed on 2018-08-21  7:42:07
